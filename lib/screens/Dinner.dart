...
class _DinnerState extends State<Dinner> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Color(0xFFF0F0F0), body: DinnerMenu());
  }
}
...
class DinnerForm extends StatefulWidget {
  ...
  DinnerForm({Key key, this.meal}) : super(key: key);

  @override
  _DinnerFormState createState() => _DinnerFormState();
}

class _DinnerFormState extends State<DinnerForm> {
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: DropdownButton<Meals>(
                          ...
                          items: widget.meal
                              .where((food) => food.category == "Drink")
                              .map((Meals value) {
