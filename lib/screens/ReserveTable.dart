...
class LoadTable extends StatefulWidget {
  @override
  _LoadTableState createState() => _LoadTableState();
}

class _LoadTableState extends State<LoadTable> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Color(0xFFF0F0F0), body: ReserveTable());
  }
}
      ...
      body: FutureBuilder<List<Meals>>(
        ...
        builder: (context, snapshot) {
          ...
          return snapshot.hasData
              ? LoadTableForm(meal: snapshot.data)
              : Center(
                  child: CircleAvatar(
                    backgroundColor: Colors.white,
                    radius: 90.0,
...
class LoadTableForm extends StatefulWidget {
  final List<Meals> meal;

  LoadTableForm({Key key, this.meal}) : super(key: key);

  @override
  _OrderFormState createState() => _OrderFormState();
}

class _OrderFormState extends State<LoadTableForm> {
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: DropdownButton<Meals>(
                        ...
                        items: widget.meal.map((Meals value) {
